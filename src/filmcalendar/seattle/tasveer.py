...
class FilmCalendarTasveer(filmcalendar.FilmCalendar):
    def __init__(self, **kwds):
        ...
        self.base_url = "https://filmcenter.tasveer.org/"
        self.calendar_url = f"{self.base_url}/showtimes"
    ...
    def fetch_films(self):
        ...
        while start_date < end_date:
            self._fetch_day_page(start_date)
            start_date = start_date + timedelta(days=1)
        return True

    def fetch_day_page(self, start_date):
        headers = {
        ...
        try:
            ...
            logger.error(f"Error fetching Tasveer calendar page: {e}")
            raise
